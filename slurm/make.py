...
BENCHMARKS = {
    ...
    "picotrav_replace": {
        dd_t.bdd: [
            # arithmetic
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "adder",      picotrav_opt_t.LEVEL_DF) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "adder",      picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "adder",      picotrav_opt_t.FANIN) ],
            ...
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.size,  "adder",      picotrav_opt_t.RANDOM) ],
          ...
          # [ [15, 0, 0], picotrav__args(epfl_spec_t.arithmetic, epfl_opt_t.depth, "square",     picotrav_opt_t.LEVEL_DF) ],
            ...
            [ [ 0, 1, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "arbiter",    picotrav_opt_t.INPUT) ],
            [ [ 0, 1, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "arbiter",    picotrav_opt_t.FANIN) ],
            [ [ 0, 1, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "arbiter",    picotrav_opt_t.FUJITA) ],
            [ [ 0, 1, 0], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "arbiter",    picotrav_opt_t.RANDOM) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "cavlc",      picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "cavlc",      picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "ctrl",       picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "ctrl",       picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "dec",        picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "dec",        picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "i2c",        picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "i2c",        picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "int2float",  picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "int2float",  picotrav_opt_t.INPUT) ],
            ...
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "priority",   picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "priority",   picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.size,  "router",     picotrav_opt_t.INPUT) ],
            [ [ 0, 0,20], picotrav__args(epfl_spec_t.random_control, epfl_opt_t.depth, "router",     picotrav_opt_t.INPUT) ],
